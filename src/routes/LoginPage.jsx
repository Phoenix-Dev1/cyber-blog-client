  ...
  return (
    <div className="flex items-center justify-center h-[calc(100vh-80px)]">
      <div className="w-full max-w-md p-8 bg-cyber-card/30 backdrop-blur-xl border border-cyber-border rounded-3xl shadow-glow-purple-sm">
        <h1 className="text-3xl font-bold mb-2 text-white tracking-tight">Login</h1>
        <p className="text-cyber-muted text-sm mb-8">Enter your credentials to access the sphere.</p>
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-xs uppercase tracking-tighter">
            <span className="bg-cyber-bg px-4 text-cyber-muted">External Auth</span>
          </div>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-cyber-muted">
          New to the sphere?{" "}
          <Link to="/register" className="text-cyber-cyan hover:text-cyber-purple font-bold transition-colors">
            Create Identity
          </Link>
        </p>
      </div>
